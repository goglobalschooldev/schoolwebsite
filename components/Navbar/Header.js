...
const Header = () => {
  ...
  return (
    <Center color="white" h="43px" p="5px" fontSize="14px" bg="brand.100">
      <Flex
        width={{ sm: "100%", md: "100%", lg: "98%", xl: "85%", "2xl": "85%" }}
      >
        <Box>
          <CopyToClipboard
            text="+855 78 900 998"
          ...
          <a
            target="_blank"
            href="https://www.youtube.com/channel/UCZgj2YSaSfRtrmLNe9s126w"
          >
        ...
        <Flex>
          <Menu isLazy>
            ...
            <MenuList position="absolute" zIndex="3" color="brand.100">
              {galery.map((item) => (
                <GalerySubMenu
                  key={item.id}
                  item={item.item}
          ...
          <Menu isLazy>
            <MenuButton
              ...
              cursor="pointer"
              borderBottom={
                path === "/faculity-staff/[faculitystaff]" ||
                path === "/faculity-staff/our-teachers"
                  ? "2px"
                  : ""
              }
            >
            ...
            <MenuList position="absolute" zIndex="3" color="brand.100">
              {staff.map((item) => (
                <SubStaffMenu key={item.id} item={item.item} link={item.link} />
              ))}
            </MenuList>
          </Menu>
          <Box ml={3} mr={3}>
          ...
          <Link href="/join-us">
            <Box
              borderBottom={
                path === "/join-us" || path === "/join-us/[jobslug]"
                  ? "2px"
                  : ""
              }
              cursor="pointer"
