  ...
  return (
    <Center p="10px">
      <Flex
        ...
        zIndex="2"
      >
        <Box width={{ sm: "100%", md: "25%", lg: "30%", xl: "30%" }}>
          <Link href="/">
            <a>
              <Image alt="Segun Adebayo" src="../Go_global_school.png" />
            </a>
          </Link>
        </Box>
        <Spacer />
        <Flex fontSize={font} mt="20px">
          ...
          <Link href="/about_us">
            <Box
              ...
              h="40px"
            >
              <a className="testAct">About US</a>
            </Box>
          </Link>
          <Menu isLazy>
            <MenuButton
            ...
            >
              {admission.map((item) => (
                <SubMenu key={item.id} item={item.item} link={item.link} />
              ))}
            </MenuList>
          </Menu>
          <Menu isLazy>
            <MenuButton
              ...
              color="brand.100"
              borderBottom={
                router.pathname === "/programme/[programme]" ||
                router.pathname === "/programme/academicCalendar"
                  ? "2px"
                  : ""
              }
              h="40px"
          ...
          <Menu isLazy>
            <MenuButton
              ...
              cursor="pointer"
              borderBottom={
                router.pathname === "/students-service" ||
                router.pathname === "/student-activity-involvement"
                  ? "2px"
                  : ""
              }
              h="40px"
