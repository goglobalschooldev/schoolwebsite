  ...
  return (
    <Box>
      <Box style={{ position: "relative" }}>
        ...
        <Center>
          <Box w={w_grid} position="absolute" top="2.5%" bottom={"50%"}>
            <Grid
              templateColumns={{ lg: "30% 70%", xl: "25% 75%" }}
              mt="200px"
              gap={5}
            >
              <GridItem colSpan={1}>
                      ...
                      placementData.getStudentResult.map((placement) => {
                        ...
                        return (
                          <PlacementCard
                            ...
                            loadingPlacementData={loadingPlacementData}
                          />
                        );
                      })}
                  </SimpleGrid>
          ...
          <Box
            h={{
              sm: `${checkHeight(heightFoot) * 4}vh`,
              md: `${checkHeight(heightFoot) * 2}vh`,
              lg: `${checkHeight(heightFoot) * 2}vh`,
              xl: `${checkHeight(heightFoot)}vh`,
            }}
          ></Box>
        </Center>
      </Box>
