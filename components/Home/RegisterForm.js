...
export default function RegisterForm() {
  ...
  return (
    <Box>
      <Center>
        <Box w={container} mt="80px" bg="white">
          <Flex w="100%">
            <Box w="35%" display={display_Image} position="relative">
              <Image
                backgroundImage="red.100"
                w="100%"
                h="840px"
            ...
            >
              ...
              >
                ...
                <Box height="20px">
                  <Input
                    value={khmerName}
                    onChange={(e) =>
                      setUser({ ...user, khmerName: e.target.value })
                    }
                    borderColor="brand.100"
                    variant="flushed"
                ...
                <Box height="20px">
                  <Input
                    value={niceName}
                    onChange={(e) =>
                      setUser({ ...user, niceName: e.target.value })
                    }
                    borderColor="brand.100"
                    variant="flushed"
                ...
                <Box height="20px">
                  <Input
                    value={transferFrom}
                    onChange={(e) =>
                      setUser({ ...user, transferFrom: e.target.value })
                    }
                    variant="flushed"
                    borderColor="brand.100"
              ...
              <SimpleGrid color="brand.100" mt={6}>
                ...
                <FormControl as="fieldset">
                  <RadioGroup defaultValue={bloodType} onChange={setBloom}>
                    <Center>
              ...
              >
                ...
                <Box height="20px">
                  <Input
                    value={motherEdu}
                    onChange={(e) =>
                      setUser({ ...user, motherEdu: e.target.value })
                    }
                    variant="flushed"
                    borderColor="brand.100"
                ...
                <Box height="20px">
                  <Input
                    value={motherPhone}
                    onChange={(e) =>
                      setUser({ ...user, motherPhone: e.target.value })
                    }
                    variant="flushed"
                    borderColor="brand.100"
                ...
                <Box height="20px">
                  <Input
                    ...
                    onChange={(e) =>
                      setUser({ ...user, motherOccupation: e.target.value })
                    }
                    variant="flushed"
                    borderColor="brand.100"
                ...
                <Box height="20px">
                  <Input
                    value={fatherEdu}
                    onChange={(e) =>
                      setUser({ ...user, fatherEdu: e.target.value })
                    }
                    variant="flushed"
                    borderColor="brand.100"
                    placeholder="Education"
                ...
                <Box height="20px">
                  <Input
                    ...
                    onChange={(e) =>
                      setUser({ ...user, fatherOccupation: e.target.value })
                    }
                    variant="flushed"
                    borderColor="brand.100"
                    placeholder="Occupation"
              ...
              <Center>
                <Flex mt={10}>
                  ...
                  <Box height="20px" ml={2} fontWeight="bold" cursor="pointer">
                    {" "}
                    Sign in{" "}
                  </Box>
                </Flex>
              ...
              <Center mt="30px">
                ...
                >
                  <Box variant="solid" color="#fff" fontFamily="Segoe UI">
                    Complete Register
                  </Box>
                </Button>
              </Center>
